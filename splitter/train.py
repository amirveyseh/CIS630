...
for epoch in range(1, opt['num_epoch']+1):
    ...
    for i, batch in enumerate(train_batch):
        ...
        global_step += 1
        loss, sel_ind = trainer.update(batch)
        train_loss += loss
        ...
        for k,v in sel_ind.items():
            all_sel_ind[k+opt['batch_size']*i] = v
    ...
    file_logger.log("new best model saved at epoch {}:".format(epoch))
